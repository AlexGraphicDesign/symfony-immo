...
{
    /**
     * Gets the public 'App\Controller\Program' shared autowired service.
     *
     * @return \App\Controller\Program
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Program.php';

        $container->services['App\\Controller\\Program'] = $instance = new \App\Controller\Program();
        ...
        ]))->withContext('App\\Controller\\Program', $container));
